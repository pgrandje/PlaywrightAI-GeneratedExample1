...
export class PeoplePage extends _BasePage {
  async goto() {
    await this.page.goto('https://paulgrandjeanphotography.com/people/', { waitUntil: 'domcontentloaded' });
  }

  async waitForLoaded() {
    await expect(this.page).toHaveURL(/\/people\/?$/, { timeout: 15000 });
  }
